...
BOT = "https://i.ibb.co/nf9hH90/Girl-pp.jpg"
IMG = [
        ...
        for member in message.new_chat_members:
            ...
            if member.id == nexichat.id:
                ...
                try:
                    ...
                    chat_photo = (
                        groups_photo if groups_photo else "https://i.ibb.co/nf9hH90/Girl-pp.jpg"
                    )
                except AttributeError:
                    chat_photo = "https://i.ibb.co/nf9hH90/Girl-pp.jpg"
